...
/***/ function(module, exports, __webpack_require__) {
	...
	var ContactItem = __webpack_require__(159);

	// This pseudo redux state
	var contacts = [{ key: 1, name: "James K Nelson", email: "blah@blah.com" }, { key: 2, name: "Mr. T", email: "ohno@mrt.com" }];

	var contactItemElements = contacts.filter(function (contact) {
	  return contact.email && contact.name;
	}).map(function (contact) {
	  return React.createElement(ContactItem, { name: contact.name, email: contact.email, key: contact.key + 'email-list-item' });
	});
